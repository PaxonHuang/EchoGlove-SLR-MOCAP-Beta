...
│   └──────────────────────────────────┼─┼┼┼┼──────┼───┼───┘   │   │
│                                      │ ││││      │   │       │   │
│   子通道上拉电阻 4.7kΩ (每个通道 SDx/SCx→3.3V, TMAG5273 到货后安装)
│                                                                  │
│   3.3V 电源总线 ──── 全部传感器供电                               │
│   GND 总线 ──────── 全部传感器共地                                │
└──────────────────────────────────────────────────────────────────┘
...
每个子通道 SDA/SCL 都需要上拉到 3.3V
Ch5 (GY-BNO085): 5.1kΩ × 2 (已安装)
Ch0-4 (TMAG5273): 4.7kΩ × 10 (到货后安装)
```
...
⚠️  上拉电阻        ─── 主总线 2kΩ, 子通道 4.7kΩ (TMAG5273 到货后安装)。
...
| I2C 间歇性失败 | 走线太长 / 上拉太弱 | 缩短排线 <30cm，确认上拉 2kΩ |
