# EchoGlove V5.0 SOP-SPEC-PLAN — 双手手语识别与动作捕捉系统
...
### ADR-D9 ~ D17: 与V4.0相同（详见06_decision_summary.md）

### ADR-D18: Gated Bidirectional CrossAttention
...
> 与V4.0 Phase 1相同，详见05_claude_code_prompts.md
...
> 与V4.0 Phase 4基本相同，L1升级为Gated Bi-CrossAttention
